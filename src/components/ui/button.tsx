  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-gold transition-smooth",
        ...
        hero: "bg-gradient-gold text-primary-foreground hover:shadow-gold hover:scale-105 transition-smooth font-semibold",
        elegant: "bg-gradient-primary text-primary-foreground hover:shadow-elegant transition-smooth border border-barbershop-gold/20",
      },
      size: {
